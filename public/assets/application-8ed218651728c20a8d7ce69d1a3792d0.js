...
(function() {
  $(function() {
    ...
    $("form.with_notifications").live('ajax:complete', function(a, b, c) {
      var r;
      console.log(r = $.parseJSON(b.responseText));
      $("#flash").addClass('showme').hide().fadeIn(400).delay(3000).fadeOut(400);
      return $("p#flash_bubble").text("" + r.flash.message).removeClass('notice').removeClass('error').addClass("" + r.flash.type);
    });
