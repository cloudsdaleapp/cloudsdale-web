...
set :branch,          "origin/server-migration-tmp"
...
role :web,  "web.cloudsdale.org"
role :app,  "web.cloudsdale.org", :primary => true
role :db,   "db.cloudsdale.org", :primary => true
role :faye, "chat.cloudsdale.org"
...
default_environment["PATH"]         = "/usr/local/rvm/gems/ruby-1.9.2-p290/bin:/usr/local/rvm/gems/ruby-1.9.2-p290@global/bin:/usr/local/rvm/rubies/ruby-1.9.2-p290/bin:/usr/local/rvm/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games"
