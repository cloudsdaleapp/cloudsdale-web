jQuery.fn.twitterButton = (el,options) ->
  $('#twitter-wjs').remove()
  $(@)
  .append('<a href="https://twitter.com/share" class="twitter-share-button" data-text="What an amazing site!" data-url="http://www.cloudsdale.org" data-via="Cloudsdale_org">Tweet</a>')
