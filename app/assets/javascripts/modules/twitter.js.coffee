jQuery.fn.twitterButton = (el,options) ->
  $('#twitter-wjs').remove()
  $(@)
  .append('<a href="https://twitter.com/share" class="twitter-share-button" data-text="Guys, join me and chat on" data-url="http://www.cloudsdale.org" data-via="cloudsdaleapp">Tweet</a>')
